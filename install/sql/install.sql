...
(1, 'Walking Customer', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-02-03 06:01:21', NULL);
...
INSERT INTO `setting` (`id`, `title`, `storename`, `address`, `email`, `phone`, `logo`, `logoweb`, `favicon`, `opentime`, `closetime`, `vat`, `discount_type`, `service_chargeType`, `currency`, `min_prepare_time`, `language`, `timezone`, `dateformat`, `site_align`, `powerbytxt`, `footer_text`) VALUES
(NULL, 'Bhojon Restaurant', 'Dhaka Restaurant', '98 Green Road, Farmgate, Dhaka-1215.', 'bdtask@gmail.com', '0123456789', NULL, NULL, 'assets/img/icons/m.png', '9:00AM', '10:00PM', 15, 1, 1, 1, '1:00 Hour', 'english', 'Asia/Dhaka', 'd/m/Y', 'LTR', 'Powered By: BDTASK, www.bdtask.com\r\n', '2017Â©Copyright');
