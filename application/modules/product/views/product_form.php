                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control text-right" id="sell_price" name="price" type="number"
                                    placeholder="0.00" tabindex="5" step="any" min="0"
                    ...
                    <?php if (empty($supplier_pr)) { ?>
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control text-right" id="cost_price" name="supplier_price"
                                        type="number" placeholder="0.00" tabindex="5" min="0" step="any">
                                </div>
                            </div>
                        </div>
                        <?php } else {
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6" <?php if ($vattaxinfo->fixed_tax != 1) {
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" tabindex="" class="form-control " id="product_vat"
                                    name="product_vat" placeholder="<?php echo display('product_vat') . ' %' ?>"
                                ...
                                <select name="supplier_id[]" class="form-control" required="">
                                    ...
                                    if (!empty($supplier) && is_array($supplier)) {
                                        foreach ($supplier as $suppliers) {
                                            $selected = (!empty($supplier_pr) && isset($supplier_pr[0]['supplier_id']) &&
                                                $supplier_pr[0]['supplier_id'] == $suppliers['supplier_id']) ? 'selected' : '';
                                    ?>
                                            <option value="<?php echo $suppliers['supplier_id']; ?>" <?php echo $selected; ?>>
                                                <?php echo htmlspecialchars($suppliers['supplier_name'], ENT_QUOTES, 'UTF-8'); ?>
                                            </option>
                                    <?php
                                        }
                                    } else {
                        ...
                        <div class="col-sm-6" <?php if ($vattaxinfo->dynamic_tax != 1) {
                            ...
                            <div class="form-group row">
                                <label for="tax" class="col-sm-4 col-form-label"><?php echo $taxss['tax_name']; ?> <i
                                        class="text-danger"></i></label>
                                <div class="col-sm-7">
                                    <input type="number" step="any" name="tax<?php echo $i; ?>" class="form-control"
