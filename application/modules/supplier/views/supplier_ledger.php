                        ...
                        <div class="col-sm-8">
                            <select name="supplier_id" class="form-control" required="">
                                ...
                                <?php foreach ($supplier as $suppliers) { ?>
                                    <option value="<?php echo html_escape($suppliers['supplier_id']) ?>" <?php if ($suppliers['supplier_id'] == $supplier_id) {
                                                                                                            echo 'selected';
                                                                                                        } ?>><?php echo html_escape($suppliers['supplier_name']) ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td align="right"><b><?php
                                                            echo (($position == 0) ? "$currency " : "$currency");
                                                            echo html_escape(number_format((float)($debit ?? 0), 2, '.', ','));
                                                            ?></b></td>
                                    <td align="right"><b><?php
                                                            echo (($position == 0) ? "$currency " : "$currency");
                                                            echo html_escape(number_format((float)($credit ?? 0), 2, '.', ','));
                                                            ?></b></td>
                                    <td align="right"><b><?php
                                                            echo (($position == 0) ? "$currency " : "$currency");
                                                            echo html_escape(number_format((float)($balance ?? 0), 2, '.', ','));
                                                            ?></b></td>
                                </tr>
                            </tfoot>
                        </table>
