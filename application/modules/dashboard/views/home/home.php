...
<div class="row d-flex flex-wrap">
    ...
    <input type="hidden" id="totalsalep" value="<?php echo html_escape($this->home_model->total_sales_amount($searchdate) ?? 0); ?>" name="">
<input type="hidden" id="totalplurchasep" value="<?php echo html_escape($this->home_model->total_purchase_amount($searchdate) ?? 0); ?>" name="">
<input type="hidden" id="totalexpensep" value="<?php echo html_escape($this->home_model->total_expense_amount($searchdate) ?? 0); ?>" name="">
<input type="hidden" id="totalemployeesalaryp" value="<?php echo html_escape($this->home_model->total_employee_salary($searchdate) ?? 0); ?>" name="">
<input type="hidden" id="totalservicep" value="<?php echo html_escape($this->home_model->total_service_amount($searchdate) ?? 0); ?>" name="">
...
<input type="hidden" id="salspurhcaselabel" value="<?php echo display("sales_and_purchase_report_summary") . ' - ' . date("Y"); ?>" name="">
