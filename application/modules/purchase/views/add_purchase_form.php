                    ...
                    <table class="table table-bordered table-hover" id="purchaseTable">
                        ...
                        <tbody id="addPurchaseItem">
                            <tr>
                                ...
                                <td class="wt">
                                    <input type="text" id="expiry_date_1" autocomplete="off"
                                        class="form-control datepicker expiry_date_1" placeholder="Expiry Date"
                                        name="expiry_date[]" />
                                </td>
                                ...
                                <td>
                                    <input type="text" name="discount_per[]" onkeyup="calculate_store(1);"
                                        onchange="calculate_store(1);" id="discount_1"
                                        class="form-control discount_1 text-right" min="0" tabindex="11"
                                        placeholder="0.00" />
                                ...
                                <td>
                                    <input type="text" name="discountvalue[]" id="discount_value_1"
                                        class="form-control text-right discount_value_1 total_discount_val" min="0"
                                        tabindex="12" placeholder="0.00" readonly />
                                </td>
                                <!-- Discount end-->
                                <!-- VAT  start-->
                                <td>
                                    <input type="text" name="vatpercent[]" onkeyup="calculate_store(1);"
                                        ...
                                        class="form-control vat_percent_1 text-right" min="0" tabindex="13"
                                        placeholder="0.00" />
                                ...
                                <td class="text-right">
                                    <input class="form-control total_price text-right total_price_1" type="text"
                                        name="total_price[]" id="total_price_1" value="0.00" readonly="readonly" />
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger text-right red" type="button"
                                        ...
                                        tabindex="8"><i class="fa fa-close"></i></button>
                                </td>
                            </tr>
                        </tbody>
                        <tfoot>
