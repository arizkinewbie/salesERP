            ...
            <div class="panel-heading">
                    ...
                    <div class="panel-body print-font-size">
                        <table width="100%">
                            ...
                            <caption class="text-center" style="border-bottom: 1px #c9c9c9 solid;">
                                <strong>
                                    <?php
                                    $fromDate = !empty($dtpFromDate) ? date('d-m-Y', strtotime($dtpFromDate)) : 'N/A';
                                    $toDate = !empty($dtpToDate) ? date('d-m-Y', strtotime($dtpToDate)) : 'N/A';
                                    echo display('balance_sheet') . ' on ' . $fromDate . ' To ' . $toDate;
                                    ?>
                                </strong>
                            </caption>
                        ...
                        <table width="99%" align="left"
                            class=" table table-striped table-bordered table-hover print-font-size general_ledger_report_tble">
                            ...
                            <tbody class="table-bordered">
                                ...
                                <?php foreach ($assets as $asset) { ?>
                                    ...
                                    <?php if (count($asset['nextlevel']) > 0) {
                ...
                <div class="text-center" id="print">
                    ...
                    <a href="<?php echo base_url('account/accounts/balance_sheet_excel/' . $dtpFromDate . '/' . $dtpToDate) ?>"
                        ...
                        <button class="btn btn-primary btn-md" name="btnPdf" id="btnPdf"><i
