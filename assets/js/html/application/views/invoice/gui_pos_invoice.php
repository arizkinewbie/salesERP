                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <form class="navbar-search" method="get"
                            ...
                            <div class="input-group">
                                <input type="text" id="product_name" class="form-control search-field" dir="ltr"
                                    value="" name="s" placeholder="Search By Product" />
                                ...
                                ?>
                                    <div class="col-xs-6 col-sm-4 col-md-4 col-p-4">
                                        <div class="panel panel-bd product-panel select_product">
                                            ...
                                            <div class="panel-footer"><?php echo $item->product_name; ?>
                                                (<?php echo $item->product_model; ?>)</div>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="product_name" class="form-control bq"
                            ...
                            <input type="text" name="product_name_m" class="form-control bq"
                                placeholder='Manual Input barcode' id="add_item_m" autocomplete='off' tabindex="1"
                                value="">
                            ...
                            <input type="text" size="100" name="customer_name" class="customerSelection form-control"
                            ...
                            <a href="#" class="client-add-btn" aria-hidden="true" data-toggle="modal"
                                data-target="#cust_info"><i class="ti-plus m-r-2"></i>New Customer </a>
                            <?php
                            ...
                            <div class="footer">
                                <div class="form-group row" style="margin-bottom:0px;">
                                    <div class="col-sm-12"> <label for="date"
                                        ...
                                        <div class="col-sm-5"> <input type="text" onkeyup="quantity_calculate(1);"
                                    ...
                                    <div class="col-sm-12"> <label for="date"
                                        ...
                                        <div class="col-sm-5"> <input type="text" id="total_discount_ammount"
                                ...
                                <div class="form-group row hiddenRow" style="margin-bottom:0px;" id="taxdetails">
                                    ...
                                    foreach ($taxes as $taxfldt) { ?>
                                        ...
                                        <div class="col-sm-12"> <label for="date"
                                            ...
                                            <div class="col-sm-5"> <input id="total_tax_ammount<?php echo $x; ?>"
                                                    tabindex="-1" class="form-control text-right valid totalTax"
                                ...
                                <div class="form-group row" style="margin-bottom:0px;">
                                    ...
                                    <div class="col-sm-12"> <label for="date"
                                        ...
                                        <div class="col-sm-5"> <input id="total_tax_amount" tabindex="-1"
                                                class="form-control text-right valid" name="total_tax" value="0.00"
                                                readonly="readonly" aria-invalid="false" type="text">
                                        </div> <a class="col-sm-2 btn btn-primary taxbutton" href="#"
                                            data-toggle="collapse" data-target="#taxdetails" aria-expanded="false"
                                            aria-controls="taxdetails"><i class="fa fa-angle-double-up"></i></a>
                                    </div>
                                    <div class="col-sm-12"> <label for="date"
                                            class="col-sm-5 col-form-label"><?php echo 'Shipping Cost' ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="shipping_cost"
                                ...
                                <div class="form-group row" style="margin-bottom:0px;">
                                    <div class="col-sm-12"> <label for="date"
                                        ...
                                        <div class="col-sm-5"> <input type="text" id="grandTotal"
                                                class="form-control text-right" name="grand_total_price" value="0.00"
                                                readonly="readonly" /></div>
                                    </div>
                                    <div class="col-sm-12"> <label for="date"
                                            class="col-sm-5 col-form-label"><?php echo display('previous'); ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="previous"
                                                class="form-control text-right" name="previous" value="0.00"
                                                readonly="readonly" /></div>
                                    </div>
                                ...
                                <div class="form-group row" style="margin-bottom:0px;">
                                    <div class="col-sm-12"> <label for="date"
                                            class="col-sm-5 col-form-label"><?php echo display('net_total'); ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="n_total"
                                                class="form-control text-right" name="n_total" value="0"
                                    ...
                                    <div class="col-sm-12"> <label for="date"
                                            class="col-sm-5 col-form-label"><?php echo display('paid_ammount') ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="paidAmount"
                                                onkeyup="invoice_paidamount();" class="form-control text-right"
                                                name="paid_amount" placeholder="0.00" tabindex="13" /></div>
                                    </div>

                                </div>
                                <div class="form-group row" style="margin-bottom:0px;">
                                    <div class="col-sm-12"> <label for="date"
                                            class="col-sm-5 col-form-label"><?php echo display('due') ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="dueAmmount"
                                                class="form-control text-right" name="due_amount" value="0.00"
                                                readonly="readonly" /></div>
                                    </div>
                        ...
                        <div class="bottomarea">
                            <div class="row">
                                ...
                                <div class="col-sm-5 text-center">
                                    <input type="button" id="full_paid_tab" class="btn btn-warning"
                                        value="<?php echo display('full_paid') ?>" tabindex="14"
                                        onClick="full_paid()" />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                <label for="email"
                                    class="col-sm-3 col-form-label"><?php echo display('customer_email') ?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" name="mobile" id="mobile" type="text"
                                        placeholder="<?php echo display('customer_mobile') ?>" min="0" tabindex="3">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="panel panel-bd">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <h4><?php echo display('product_model') ?> :<span id="modal_productmodel"></span>
                                        </h4>
